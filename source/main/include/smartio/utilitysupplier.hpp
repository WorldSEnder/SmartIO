...
//};
    ...
    template<typename Container>
      void
      fill_list (ReadContext& ctx, Container& list, size_t c)
      {
	...
	typename, typename > class List = std::list>
      List<T, Alloc>
      constsize_list (ReadContext& ctx)
      {
	List<T, Alloc> list;
    ...
    template<typename T, ReadContext::key_t key,
	typename Alloc = std::allocator<T>,
	template<typename, typename > class List = std::list>
      List<T, Alloc>
      indirectsize_list (ReadContext& ctx)
      {
	List<T, Alloc> list;
	...
	typename > class List = std::list>
      List<T, Alloc>
      varsize_list (ReadContext& ctx, size_t c)
      {
	List<T, Alloc> list;
